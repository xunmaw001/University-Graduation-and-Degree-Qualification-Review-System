        ...
        try {
            ...
            if(rows>1){
                ...
                for (int i = 1; i < rows; i++) {
                    ...
                    jiaoshiEntity.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
                    ...
                    String dianhuahaoma = CommonUtil.getCellValue(row.getCell(5));
                    jiaoshiEntity.setDianhuahaoma(dianhuahaoma);
